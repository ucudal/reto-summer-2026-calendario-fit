...
DROP TABLE IF EXISTS `requerimientos_salon`;--> statement-breakpoint
DROP TABLE IF EXISTS `salon_requerimiento_salon`;--> statement-breakpoint
DROP TABLE IF EXISTS `grupo_requerimiento_salon`;--> statement-breakpoint
